...
import { deleteNote, getAllNotes } from "@/server/actions/note.action";
            ...
            >
                ...
                >
                    ...
                    <div className="w-full flex justify-between items-center">
                        ...
                        <DropdownMenuContent>
                            ...
                            <DropdownMenuItem 
                                ...
                                onClick={(e) => {handleNoteDelete(note.id); e.stopPropagation()}}
                            >
                                {isDeleting ? 
                                    <>
                    ...
                    <div className="w-full flex justify-between items-center mt-auto">
                        ...
                        >
                            <Star className="fill-yellow-400 size-4 md:size-4" />
                        </button>
                    </div>
                </SpotlightCard>
