      ...
      <div className='grid grid-cols-1 md:grid-cols-10 min-h-screen grid-rows-5'>
        ...
        <div id="leftSideHeroContent" className=' md:col-span-5 self-center items-center row-span-4'>
          ...
          <div className='flex flex-col gap-3'>
            ...
            <button className="inline-block mt-5 max-w-sm relative  h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
